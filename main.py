...
def runMStreamF(K, MaxBatch, AllBatchNum, alpha, beta, iterNum, sampleNum, dataDir, dataset, timefil, wordsInTopicNum):
    mstream = MStream(K, MaxBatch, AllBatchNum, alpha, beta, iterNum, sampleNum, dataDir, dataset, timefil, wordsInTopicNum)
...
def runMStream(K, MaxBatch, AllBatchNum, alpha, beta, iterNum, sampleNum, dataDir, dataset, timefil, wordsInTopicNum):
    mstream = MStream(K, MaxBatch, AllBatchNum, alpha, beta, iterNum, sampleNum, dataDir, dataset, timefil, wordsInTopicNum)
    mstream.getDocuments()
    for sampleNo in range(1, sampleNum+1):
        print("SampleNo:"+str(sampleNo))
